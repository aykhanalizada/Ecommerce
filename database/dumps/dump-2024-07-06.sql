...
CREATE TABLE `related_products` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_id_product` (`fk_id_product`),
  KEY `fk_id_related_product` (`fk_id_related`),
  CONSTRAINT `related_products_ibfk_1` FOREIGN KEY (`fk_id_product`) REFERENCES `product` (`id_product`) ON DELETE CASCADE,
  CONSTRAINT `related_products_ibfk_2` FOREIGN KEY (`fk_id_related`) REFERENCES `product` (`id_product`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2024-07-06 20:16:03
